            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-9">
                    <div class="card text-center wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                        <div class="icon">
                            <img src="Img/hombre.png" class="img-fluid" alt="Producto 3">
                        </div>
                    ...
                    <div class="card text-left wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                        ...
                        <a class="genric-btn success wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="ActualizarAdmin.html">Editar Información</a>
                    </div>
                </div>
            </div>
        </div>
