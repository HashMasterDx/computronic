        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-md-9">
                  <form method="post" class="formulario" action="{{('subirproducto')}}">
                        @csrf
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="col-md-6">
                                                    <div class="single_input wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                                                        <p>Nombre Producto.</p>
                                                        <input type="name" placeholder="Nombre" name="producto">
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single_input wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                                    ...
                                                    <input type="number" placeholder="Cantidad" name="existencia" >
                                                </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single_input wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                                <p>Numero.</p>
                                                <input type="number" placeholder="Numero" name="num" >
                                            </div>
                                    </div>
                                            <div class="col-md-12">
                                                    <div class="single_input wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                                                        <p>Descripción Producto.</p>
                                                        <textarea  id="textarea" cols="30" placeholder="Descripción" rows="10" name="descripcion" ></textarea>
                                                    </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="single_input wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                                    <p>Imagen Producto.</p>
                                                    <input type="file" id="" name="imagen">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="submit_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
                                                        <a href="#" class="genric-btn danger radius">Cancelar</a>
                                                          <button type="submit" class="genric-btn primary radius">Subir</button>
                                                </div>
                                            </div>
                                            </div>
                                        </form>
