                    ...
                    <div class="row align-items-center no-gutters">
                            ...
                            <div class="main-menu  d-none d-lg-block text-center">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="{{url('/Admin_profile/')}}">Admin</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        <div class="col-lg-2 d-none d-lg-block">
                            <div class="log_chat_area d-flex align-items-end">
                                <a href="{{url('/perfil/')}}" class="say_hi">Perfil</a>
                            </div>
                        </div>
                        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xl-3 col-md-3">
                    <div class="card wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                        ...
                        <ul class="list cat-list">
                            <li class="active">
                                <a href="perfil.html" class="d-flex">
                                    <p>Información Personal</p>
                                </a>
                            </li>
                            <br>
                            <li>
                                <a href="Carrito.html" class="d-flex ">
                                    <p>Carrito</p>
                                </a>
                            </li>
                            <br>
                            <li>
                                <a href="MetodoPago.html" class="d-flex">
                ...
                <div class="col-xl-9 col-md-9">
                    <div class="card text-center wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                        <div class="icon">
                            <img src="Img/persona.png" class="img-fluid" alt="Producto 3">
                        </div>
                        <h3>Lennyn Leyva Andrade</h3>
                        <br>
                    <div class="card text-left wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                        <h4>Dirección</h4>
                        <p>Lomas de morelia 467 col.morelialoc</p>
                        <h4>Correo Electronico</h4>
                        <p>leanleanñea@gmail.com</p>
                        <h4>Contraseña</h4>
                        <p>*******</p>
                    </div>
                        <a class="genric-btn success wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="ActualizarUsuario.html">Editar Información</a>
                    </div>
                </div>
            </div>
        </div>
